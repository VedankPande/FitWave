...
export function Monitor(exercise, pose) {
  ...
  const check_bicep = () => {
    var hip = {
      x: pose[KEYPOINT_DICT["left_hip"]].x,
      y: pose[KEYPOINT_DICT["left_hip"]].y,
    };
    var shoulder = {
      x: pose[KEYPOINT_DICT["left_shoulder"]].x,
      y: pose[KEYPOINT_DICT["left_shoulder"]].y,
    };
    var elbow = {
      x: pose[KEYPOINT_DICT["left_elbow"]].x,
      y: pose[KEYPOINT_DICT["left_elbow"]].y,
    };
    var knee = {
      x: pose[KEYPOINT_DICT["left_knee"]].x,
      y: pose[KEYPOINT_DICT["left_knee"]].y,
    };
  ...
  const check_plank = () => {
    ...
    var right_shoulder = {
      x: pose[KEYPOINT_DICT["right_shoulder"]].x,
      y: pose[KEYPOINT_DICT["right_shoulder"]].y,
    };
    var left_hip = {
      x: pose[KEYPOINT_DICT["left_hip"]].x,
      y: pose[KEYPOINT_DICT["left_hip"]].y,
    ...
    var right_hip = {
      x: pose[KEYPOINT_DICT["right_hip"]].x,
      y: pose[KEYPOINT_DICT["right_hip"]].y,
    };
    var left_knee = {
      x: pose[KEYPOINT_DICT["left_knee"]].x,
      y: pose[KEYPOINT_DICT["left_knee"]].y,
    ...
    var right_knee = {
      x: pose[KEYPOINT_DICT["right_knee"]].x,
      y: pose[KEYPOINT_DICT["right_knee"]].y,
    };
  ...
  const check_shoulder_press = () => {
    ...
    var right_elbow = {
      x: pose[KEYPOINT_DICT["right_elbow"]].x,
      y: pose[KEYPOINT_DICT["right_elbow"]].y,
    };
    var left_shoulder = {
      x: pose[KEYPOINT_DICT["left_shoulder"]].x,
      y: pose[KEYPOINT_DICT["left_shoulder"]].y,
    ...
    if (
      (left_arm > 170 || left_arm < 150) &&
      (right_arm > 170 || right_arm < 150)
    ) {
      return false;
    } else {
      return true;
